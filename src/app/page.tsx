  ...
  return (
    <div style={{ maxWidth: 1280, margin: '0 auto', padding: '2.5rem 1.5rem', display: 'flex', flexDirection: 'column', gap: '3.5rem' }}>
      ...
      <section style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <h1 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.6rem)', fontWeight: 800, lineHeight: 1.1, color: '#f0ebe2', margin: 0 }}>
          Audit de cohérence documentaire
        </h1>
        <p style={{ color: '#a8a490', fontSize: '1rem', maxWidth: 680, margin: 0, lineHeight: 1.65 }}>
        ...
        <div style={{
          ...
          backgroundColor: 'rgba(187,164,107,0.08)', border: '1px solid rgba(187,164,107,0.22)',
          borderRadius: 10, padding: '12px 16px', maxWidth: 680,
        }}>
          <span style={{ fontSize: '0.95rem', color: '#BBA46B', flexShrink: 0 }}>ℹ</span>
          <span style={{ fontSize: '0.87rem', color: '#a8a490', lineHeight: 1.65 }}>
      ...
      <section style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(170px, 1fr))', gap: 14 }}>
        {[
          ...
          <div key={kpi.label} style={{
            backgroundColor: '#183148', border: '1px solid #1f3a58',
      ...
      <section style={{ backgroundColor: '#183148', border: '1px solid #1f3a58', borderRadius: 18, padding: '28px' }}>
        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: 20, marginBottom: 22 }}>
          <div>
            <div style={{ fontSize: '0.87rem', color: '#a8a490', marginBottom: 6, letterSpacing: '0.02em' }}>Score pondéré global · FPCI IRDInov\u00a03</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, minWidth: 290 }}>
            {data.parties.map(p => (
              <div key={p.id} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <span style={{ fontSize: '0.82rem', color: '#a8a490', width: 90, flexShrink: 0 }}>
      ...
      <section>
        <div style={{ marginBottom: 18 }}>
          <h2 style={{ fontSize: '1.28rem', fontWeight: 700, color: '#f0ebe2', margin: 0 }}>
            Analyse Concordance — les cinq couches documentaires
          </h2>
          <p style={{ fontSize: '0.92rem', color: '#a8a490', marginTop: 6, marginBottom: 0, lineHeight: 1.65 }}>
        ...
        <div style={{ display: 'flex', gap: 14, marginTop: 14, flexWrap: 'wrap' }}>
          {[
            ...
            <div key={label} style={{ display: 'flex', alignItems: 'center', gap: 7, fontSize: '0.82rem', color: '#a8a490' }}>
      ...
      <section>
        <h2 style={{ fontSize: '1.28rem', fontWeight: 700, color: '#f0ebe2', margin: '0 0 18px' }}>
          Scores SFDR par partie
        </h2>
      ...
      <section>
        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'flex-start', justifyContent: 'space-between', gap: 14, marginBottom: 18 }}>
          <div>
            ...
            <p style={{ fontSize: '0.92rem', color: '#a8a490', marginTop: 6, marginBottom: 0 }}>
      ...
      <section style={{ backgroundColor: 'rgba(187,164,107,0.06)', border: '1px solid rgba(187,164,107,0.2)', borderRadius: 18, padding: '28px' }}>
        <h3 style={{ fontSize: '1.05rem', fontWeight: 700, color: '#f0ebe2', marginTop: 0, marginBottom: 14 }}>
          Ce que révèle ce rapport
        </h3>
        ...
        <div style={{ marginTop: 18, paddingTop: 18, borderTop: '1px solid rgba(187,164,107,0.15)', display: 'flex', flexWrap: 'wrap', gap: 8 }}>
